...
<head>
    ...
    {{-- <link href="{{ asset('dataTables/dataTables-1.11.2/css/jquery.dataTables.min.css') }}" rel="stylesheet" /> --}}
    ...
    <link href="{{ asset('css/full-screen-helper.css') }}" rel="stylesheet" />
...
<body class="app header-fixed sidebar-fixed {{ request()->is('admin/timetable/create') || request()->is('admin/calling_dashboard/*') || request()->is('admin/createexamschedule') ? 'sidebar-minimized':'' }}  aside-menu-fixed pace-done sidebar-lg-show">
   ...
   {{-- <script src="{{ asset('js/dataTables/buttons-2.0.0/js/buttons.flash.min.js') }}"></script>  --}}
    ...
    {{-- <script src="https://cdn.ckeditor.comd/ckeditor5/16.0.0/classic/ckeditor.js"></script> --}}
    ...
    <script src="{{ asset('js/full-screen-helper.min.js') }}"></script>
...
<script>
  ...
  function go_logout(e){
       ...
       // beamsClient.stop();
       // beamsClient.removeDeviceInterest('{{ config('services.pusher')['interest'] }}');// for pusher bean
