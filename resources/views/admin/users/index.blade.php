                    ...
                    @if (in_array(request()->role, [3, 4]))
                        <div class="col">
                            <div class="form-group row">
                                <label class="required col-sm-2 col-form-label text-nowrap" for="class_id">Campus</label>
                                <div class="col-sm-3">
                                    <select class="custom-select {{ $errors->has('campus') ? 'is-invalid' : '' }}"
                                        name="campus" id="campus"
                                        onchange="document.getElementById('classes').selectedIndex=0;document.forms['frmcampus'].submit()">
                                ...
                                <div class="col-sm-5">
                                    <select class="custom-select {{ $errors->has('classes') ? 'is-invalid' : '' }}"
                                        name="classes" id="classes" onchange="document.forms['frmcampus'].submit()">
                                        @foreach ($classes as $id => $key)
                                            <option value="{{ $id }}"
                                                {{ old('classes') == $id ? 'selected' : '' }}
                                                {{ $id == $current_filter['class'] ? 'selected' : '' }}>
                                                {{ $key }}
                                            </option>
                                        @endforeach
                                    </select>
