...
//     }
    ...
    $check_in = Attendance::whereDate('date',date_format(date_create($date),"Y-m-d"))->where('student_id',$this->id)->orderBy('date','asc')->where('status','Present')->first();
    $check_out = Attendance::whereDate('date',date_format(date_create($date),"Y-m-d"))->where('student_id',$this->id)->orderBy('date','desc')->where('status','Present')->first();
