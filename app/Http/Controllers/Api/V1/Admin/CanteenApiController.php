    ...
    public function get_abaqrcodelist(){
        ...
        $data=[
            'data' => [
                [
                    'amount' => 5,
                    'image' => url('storage/aba_qrcode/aba_qrcode_5.png'),
                    'link' => "https://link.payway.com.kh/ABAPAYqq164498h"
                ],
                [
                    'amount' => 10,
                    'image' => url('storage/aba_qrcode/aba_qrcode_10.png'),
                    'link' => "https://link.payway.com.kh/ABAPAYdf114639o"
                ],
                [
                    'amount' => 20,
                    'image' => url('storage/aba_qrcode/aba_qrcode_20.png'),
                    'link' => "https://link.payway.com.kh/ABAPAYB7114640y"
                ],
                [
                    'amount' => 50,
                    'image' => url('storage/aba_qrcode/aba_qrcode_50.png'),
                    'link' => "https://link.payway.com.kh/ABAPAYwh1146417"
                ] ,
                [
                    'amount' => 100,
                    'image' => url('storage/aba_qrcode/aba_qrcode_100.png'),
                    'link' => "https://link.payway.com.kh/ABAPAYZk114642G"
                ]      
