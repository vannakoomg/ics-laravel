...
class NotificationApiController extends Controller
{
	...
	if(array_key_exists('message_id',$data['data'])){
		$trid=$data['data']['message_id'];
		if(is_numeric($trid)){
			$arr_data = Message::find($trid);
			//return response()->json($data['data']['title']);
			$new_arr = $data['data'];
			$new_arr['title'] = $arr_data->title;
			$new_arr['message'] = $arr_data->body;
			$new_arr['image'] = $arr_data->thumbnail;
			$new_arr['fullimage'] = $arr_data->full_image;
